            ...
            <div class="content-in-main">
              ...
              <div class="question-blocks">
                ...
                <div class="task-right-block">
                  ...
                  <span required class="field-label-required task-subtitle">Contacts</span>
                  ...
                  <div class="subtask-container form-size" id="subtaskContainer">
...
//if opening some overlay: give currOverlay an value;
//if rendering one overlay, empty another one;
  ...
  return `<div onclick="event.stopPropagation()" id="taskDetailedOverlay">
    <div class="question-blocks">
      <div class="task-left-block">
        ...
        <div class="title-field-space">
          <span class="field-label-required due-date-title task-subtitle">Due date</span>
          <input onkeydown="blurOnEnter(event)" id="taskDate" required class="due-date-field task-txt" type="date" />
        </div>
      </div>
      <div class="vertical-line"></div>
      <div class="task-right-block">
        ...
        <div class="dropdown-wrapper">
          <div class="assignment-toggle-buttons">
          <div id="closedState" onclick="openContactAssignmentInput()" class="dropdown-btn">
            <span class="task-txt">Select contacts to assign</span>
            <div class="dropdown-icon-wrapper">
              <img class="dropdown-icon" src="../img/dropdown-arrow-down.png" alt="dropdown arrow">
            </div>
          </div>
          <div style="display: none;" id="searchState">
            <input id="searchContacts" oninput="searchForContacts()" onkeydown="blurOnEnter(event)" type="text">
            <div onclick="closeContactAssignment()" class="arrow-up-wrapper">
              <img src="../img/dropdown-arrow-up.png" alt="dropdown arrow">
            </div>
          ...
          <div id="contactOptions" class="options">
          </div>
          </div>
          <div id="chosenContactsBox"></div>
        </div>
        ...
        <div id="focusBtns" class="subtask-focus-btns">
          <div onclick="emptySubtaskInput()" class="subtask-btn-wrapper">
            <img src="../img/subtask_del.png" alt="del">
          </div>
          <div class="subtask-btns-separator"></div>
          <div onclick="addSubtask()" class="subtask-btn-wrapper">
            <img src="../img/subtask_add.png" alt="add">
          </div>
        </div>
        </div>
    ...
    <svg class="edit-accept-button" width="90" height="58" viewBox="0 0 90 58" fill="none" xmlns="http://www.w3.org/2000/svg">
