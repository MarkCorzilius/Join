...
function editTaskTemplate() {
  return `<div onclick="event.stopPropagation()" class="detailed-overlay" id="taskDetailedOverlay">
    <div class="edit-data-container">
         <div class="title-field-space">
       <span required class="">Title</span>
       <input onkeydown="blurOnEnter(event)" id="taskTitle" class="form-border" placeholder="Enter a title" type="text" />
     </div>
      <div class="title-field-space">
       <span class="" for="description">Description</span>
       <textarea class="form-border form-description" id="description" name="description" placeholder="Enter a description"></textarea>
     </div>
     <div class="title-field-space">
       <span class="">Due date</span>
       <input onkeydown="blurOnEnter(event)" id="taskDate" required class="form-border" type="date" />
     </div>
